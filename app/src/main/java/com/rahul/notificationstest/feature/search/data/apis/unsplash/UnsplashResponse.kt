...
data class UnsplashResponse(
    ...
    @Json(name = "current_user_collections") var currentUserCollections: ArrayList<String> = arrayListOf(),
    ...
    data class Sponsorship(
        ...
        @Json(name = "impression_urls") var impressionUrls: ArrayList<String> = arrayListOf(),
